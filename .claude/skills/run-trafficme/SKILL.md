---
name: run-trafficme
description: Lanza trafficMe (app de escritorio PySide6) desde código fuente en Windows para probar cambios manualmente. Trigger - cuando pidan correr, levantar, probar o ver la app andando.
---

# Run trafficMe (desktop, Windows, desde código fuente)
...
```bash
tail -10 "/c/Users/Gabriel Maglia/AppData/Local/trafficMe/monitor.log"
```
...
`%LOCALAPPDATA%\trafficMe\` → `monitor.log`, `settings.json`, `usage.db`, `reports/`.
