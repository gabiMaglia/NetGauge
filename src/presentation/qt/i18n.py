...
_STR: dict[str, dict[str, str]] = {
    "es": {
        ...
        "alert.update.body": "NetGauge {v} está disponible. Descargala en {url}",
    ...
    "en": {
        ...
        "alert.update.body": "NetGauge {v} is available. Download it at {url}",
    ...
    "pt": {
        ...
        "alert.update.body": "NetGauge {v} está disponível. Baixe em {url}",
        "mode.etw": "ETW · por app", "mode.global": "Global",
